package com.zwq.demoshow.config;

import com.zwq.demoshow.serializer.FastJsonRedisSerializer;
...
public class RedisConfig {
    ...
    这里用的是自定义的序列化类，本来想用protostuff，但是反序列化需要一个类模板，所以未采用.
     ...
     * @return
     */
    public static RedisTemplate<Object, Object> setFastJsonSerialize(RedisTemplate<Object, Object> redisTemplate) {
