package com.zwq.commons.serializer;
...
public class ProtoStuffSerializer {
    /*
    因为这个工具不是用来设置redis的默认序列化方法，所以没必要实现RedisSerializer<T>接口
     */
    private static Logger log = LoggerFactory.getLogger(ProtoStuffSerializer.class);
